...
class AllProjectsArchivedTab extends StatefulWidget {
  ...
  @override
  AllProjectsArchivedTabState createState() => AllProjectsArchivedTabState();
}

class AllProjectsArchivedTabState extends State<AllProjectsArchivedTab> {
    ...
    try {
      ...
      if (token != null) {
        final response = await http.get(
          Uri.parse('http://34.16.137.128/api/project/company/$companyId?typeFlag=2'),
